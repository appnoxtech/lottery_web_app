...
import { Trophy, Calendar, DollarSign, Phone, Award, Filter, Download, Eye } from 'lucide-react';
        ...
        <main className="flex-1 p-6 overflow-y-auto">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
              <div className="bg-[#2A2D36] rounded-lg p-6 border border-gray-700">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-400">Total Winners</p>
              ...
              <div className="bg-[#2A2D36] rounded-lg p-6 border border-gray-700">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-400">Prizes Claimed</p>
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody className="divide-y divide-gray-700">
                    {winners.map((winner) => (
                      <tr key={winner.id} className="hover:bg-[#3A3D46] transition-colors">
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              ...
                              <div className={`text-xs font-medium ${getPrizeTypeColor(winner.prizeType)}`}>
                                {winner.prizeType.charAt(0).toUpperCase() + winner.prizeType.slice(1)} Prize
                              </div>
                            </div>
                          </div>
                        </td>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div>
                            <span className={`inline-flex px-2 py-1 text-xs font-medium rounded-full border ${getClaimStatusColor(winner.claimStatus)}`}>
            ...
            <div className="mt-8 bg-[#2A2D36] rounded-lg border border-gray-700 p-6">
              <h3 className="text-lg font-semibold text-white mb-4">Recent Winner Activity</h3>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4 p-3 bg-[#1D1F27] rounded-lg">
                  ...
                  <div className="flex-1">
                    <p className="text-sm text-white">
                      <span className="font-medium">John Doe</span> claimed ₹50,000 prize from Super Lucky Draw
                    </p>
                ...
                <div className="flex items-center space-x-4 p-3 bg-[#1D1F27] rounded-lg">
                  ...
                  <div className="flex-1">
                    <p className="text-sm text-white">
                      New winner announced for <span className="font-medium">Mega Jackpot</span> - ₹25,000
                    </p>
