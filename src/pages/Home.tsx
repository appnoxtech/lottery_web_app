            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-[#2A2D36] rounded-lg p-6 border border-gray-700 hover:border-[#EDB726] transition-colors">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-semibold text-white">New Lottery</h3>
                  <div className="w-12 h-12 bg-[#EDB726] rounded-lg flex items-center justify-center">
                    <svg className="w-6 h-6 text-[#1D1F27]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                    </svg>
                  </div>
                </div>
                <p className="text-gray-400 mb-4">Create and manage new lottery draws</p>
                <button className="w-full bg-[#EDB726] text-[#1D1F27] font-semibold py-2 px-4 rounded-lg hover:bg-[#d4a422] transition-colors">
                  Create Lottery
                </button>
              </div>
              ...
              <div className="bg-[#2A2D36] rounded-lg p-6 border border-gray-700 hover:border-[#EDB726] transition-colors">
                ...
                <p className="text-gray-400 mb-4">View and manage lottery tickets</p>
                <button className="w-full bg-[#EDB726] text-[#1D1F27] font-semibold py-2 px-4 rounded-lg hover:bg-[#d4a422] transition-colors">
                  View Tickets
                </button>
              </div>
              ...
              <div className="bg-[#2A2D36] rounded-lg p-6 border border-gray-700 hover:border-[#EDB726] transition-colors">
                ...
                <p className="text-gray-400 mb-4">View lottery winners and results</p>
                <button className="w-full bg-[#EDB726] text-[#1D1F27] font-semibold py-2 px-4 rounded-lg hover:bg-[#d4a422] transition-colors">
                  View Winners
                </button>
              </div>
            ...
            <div className="mt-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="bg-[#2A2D36] rounded-lg p-4 border border-gray-700">
                  ...
                  <div className="text-sm text-gray-400">Winners This Month</div>
                </div>
                <div className="bg-[#2A2D36] rounded-lg p-4 border border-gray-700">
